...
import { EventData } from "../../services/User/eventService";
import { useNavigate } from "react-router-dom";
import RazorpayX from "../PaymentComponets/Razorpay";
...
export const TicketModal: React.FC<TicketModalProps> = ({
  ...
  const [tickets, setTickets] = useState<TicketType[]>([
    {
      type: "normal",
      price: parseFloat(event.price) || 80,
      quantity: 0,
      seatInfo: "R 20",
    },
    {
      type: "VIP",
      price: parseFloat(event.price) * 1.5 || 120,
      quantity: 0,
      seatInfo: "H 13, H 16",
    },
  ]);
  ...
  const handleProceed = () => {
    ...
    // No need for payment handling here; RazorpayX will handle it
  };
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="md:w-1/2">
                <img
                  src={
                    event.bannerImage ||
                    "https://res.cloudinary.com/dupo7yv88/image/upload/v1741252210/gu767rm9tf8ukr19mfsh.jpg"
                  }
                  alt="Event poster"
                  width={300}
                  height={300}
          ...
          <div className="space-y-6 py-4">
                ...
                <div className="md:w-1/4 flex justify-center items-start">
                  <div className="text-center">
                    ...
                    <div className="text-xs font-semibold">
                      {bookingId.substring(0, 7).toUpperCase()}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              ...
              <div>
                ...
                <div className="font-medium">Razorpay</div> {/* Updated from Stripe */}
              </div>
              <div>
